      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Trusted by <span className="text-blue-400">{formatNumber(data.userCount)}</span> Developers
          </h2>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          <div className="p-6 bg-slate-800/50 rounded-xl border border-slate-700 text-center">
            ...
            <p className="text-3xl font-bold text-white mb-1">{formatNumber(data.userCount)}</p>
            <p className="text-gray-400 text-sm">Active Users</p>
          </div>

          <div className="p-6 bg-slate-800/50 rounded-xl border border-slate-700 text-center">
            <CheckCircle className="w-8 h-8 text-green-400 mx-auto mb-3" />
            <p className="text-3xl font-bold text-white mb-1">{formatNumber(data.queriesSolved)}</p>
            <p className="text-gray-400 text-sm">Queries Solved</p>
          </div>

          <div className="p-6 bg-slate-800/50 rounded-xl border border-slate-700 text-center">
            <Zap className="w-8 h-8 text-yellow-400 mx-auto mb-3" />
            <p className="text-3xl font-bold text-white mb-1">{data.stats.avgResponseTime}</p>
            <p className="text-gray-400 text-sm">Avg Response</p>
          </div>

          <div className="p-6 bg-slate-800/50 rounded-xl border border-slate-700 text-center">
            <Code className="w-8 h-8 text-purple-400 mx-auto mb-3" />
            <p className="text-3xl font-bold text-white mb-1">{data.stats.languagesSupported}+</p>
