...
export const LoginForm: React.FC = () => {
  ...
  // Debug OTP changes
  useEffect(() => {
    console.log('🔢 OTP changed:', otp, 'Length:', otp.length, 'Button enabled:', otp.length === 6 && !isLoading && !isVerifying);
  }, [otp, isLoading, isVerifying]);
  ...
  const verifyOTP = useCallback(async (otpToVerify: string) => {
    console.log('🔐 verifyOTP called with:', { otp: otpToVerify, isVerifying, otpLength: otpToVerify.length });
    ...
    if (otpToVerify.length !== 6) {
      console.log('❌ OTP length invalid:', otpToVerify.length);
    ...
    try {
      console.log('📞 Calling loginStep2 with OTP:', otpToVerify);
      const result = await loginStep2(otpToVerify);
      console.log('📦 loginStep2 result:', result);
  ...
  }, [loginStep2, navigate, isVerifying]);
    ...
    return (
      <>
        <div className="text-center mb-8">
          <div className="bg-cyan-500/20 rounded-full h-16 w-16 flex items-center justify-center mx-auto mb-4">
              ...
              <div>
                ...
                <OTPInput
                  ...
                  onComplete={(completedOtp) => {
                    console.log('🎯 OTP Complete callback received:', completedOtp);
                    setOtp(completedOtp);
          ...
          <form onSubmit={handleStep1Submit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                disabled={isLoading}
                className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent disabled:opacity-50"
